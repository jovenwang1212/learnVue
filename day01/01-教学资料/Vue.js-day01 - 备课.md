...
> 1. 首先呢，我们来看一下课程的安排
> 2. 从Vue的课程总天数来看，从38期开始由17天增加到27天啦。这种变化也是为了更好地适应市场，市场需要很多会Vue的人才。
> 3. 27天的课程分为3个阶段，vue基础和两个大项目阶段，分别是黑马头条的后台管理系统和黑马头条移动端。
> 4. Vue的基础课程，总共7天，会讲到Vue语法，指令，还有一些小的案例把知识点串起来。
...
> 1. 我说一下我是怎么学习vue.js。分期乐会员的前端架构是我搭的，基于Vue，但是在此之前我都没接触过Vue，我是在入职前参考了官方文档，从前到尾看一了一遍，重要的代码敲了，然后实际工作中遇到问题， 再回头看看这份文档。妥妥的。
> 2. 那么接下来Vue的学习，会参考文档教程。我们的大纲基本入门教程一样的，循序渐进。每一个知识下边，还有一种链接直达
> 3. 和并不会覆盖教程的各个方面，重要的地方或实际工作中用得多的会重点练习。而且会用案例和项目把知识点串起来，在实际的应用场景里面会复习已经学过知识点和补充知识点。
> 4. 总体来说，Vue语法不算难，但是比js过渡到jquery要稍难点。先要顺应Vue的语法。在学习过程中，理解Vue的精髓。
